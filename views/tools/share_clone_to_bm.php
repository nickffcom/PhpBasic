...
<div id="app">
    <div class="row">
        ...
        <div class="col-12"> 
            <h3><span class="mr-2"><i class="fas fa-arrow-alt-circle-right"></i></span>Share TKQC Clone/Via Sang 1 BM để cầm (Share Dòng 2 Chú ý)  </h3>
        </div>
        ...
        <div class="col-12">
            <div class="col-12 col-xl-12 ft-description">
                ...
                <span class="text-success">
                    + Share (Chia sẻ quyền tài khoản quảng cáo của nick Clone or Via vào 1 BM (Bussiness Manager))
                    <br>
                    + Tool sẽ login vào nick Clone / Via mà bạn đã thêm vào và share tkqc đầu tiên nó tìm thấy qua cho BM cầm
                    <br>
                    + BM cầm đó phải very Email rồi + Đã chọn Page chính thì mới được nhé !!! Chú ý nha các ck , chưa thì méo share đc đâu
        ...
        <div class="col-12">  
            <div class="col-12 col-xl-12 ft-description">
                    <h4 class="text-primary"> Hướng dẫn sử dụng <a class="text-danger" href="https://youtu.be/GABk6nUQcSg">https://youtu.be/GABk6nUQcSg</a>
                        <br>
                    <span class="text-success">
                        + B1 :Điền token EAAB or EAAG của BM muốn nhận tkqc  và ID BM muốn nhận tkqc
                        <br>
                        + B2 :Thêm clone / Via nick muốn shae tkqc vào  
                        <br>
                    ...
                    Nếu chưa biết cách chạy thì vào đây - Tôi và 500 ae sẫn sàng chỉ bạn dùng :D <a class="text-danger" href="https://zalo.me/g/hztoxf367">https://zalo.me/g/hztoxf367</a>  
                </h4>
                  ...
                  <div class="col-12 input-group ml-0">
                        ...
                        <div class="input-group-prepend ml-0">
                                <div class="input-group-text">
                                    <label>Điền token EAAB (ngon nhất) hoặc EAAG nick muốn nhận +++++<input type="text" class="form-control" aria-label="Text input with checkbox" value="haha" v-model="options.tokenvia">    </label>
                                   
                                </div>
                                <div class="input-group-text">
                                <label>Điền ID BM muốn nhận<input class="ml-3"type="text" value=""v-model="options.idbm">    </label>
                                </div>
        ...
        <div class="col-12 mt-5 mb-3">
            <div class="col-12">
                <button class="btn btn-success btn-xs ml-3"  @click="run_share_clone_to_bm()" :disabled="data_acc_is_stop"><span class="mr-2"><i class="far fa-star"></i></span>Bắt đầu</button>
        ...
        var app = new Vue({
            ...
            methods: {
                    ...
                    for (var item of get_datas) {
                        ...
                        if (info_data.length == 1) {
                           ...
                           if(info_data[0].includes('c_user')){
                            ...
                            info._2fa = info_data[2];
                            info.cookie = info_data[3];
                            info.ads_id=info_data[4];
                            info.ads_name=info_data[5];
                            info.data = item;
                        }
                ...
                data_acc_export_selected: function() {
                    ...
                    for (let row of this.data_acc) {
                        if (row.checked == true) {
                            data += row.uid + '|' + row.pass + '|' + row._2fa + '|' + row.cookie +'|'+row.status+'\n';
                        }
                    }
                    var today = new Date();
                ...
                run_share_clone_to_bm:function(){
                    var self=this;
                    var options = self.options;
                    var input=options.tokenvia;
                    console.log(input);
                    console.log(options.idbm);
                    ...
                    if(!input.includes("EAAG")&&!input.includes('EAAB')){
                        alert("Vui lòng nhập Token BM nhận EAAG hoặc EAAB");
                        return;
                    }else if(!options.idbm){
                        alert("Vui lòng nhập  ID bm nhận thật chính xác");
                        return;
                    }
                    ...
                    for (var i = 0; i < this.options.so_luong; ++i) {
                        ...
                        self.share_clone_to_bm(this.data_acc_selected[i].index, i, (0 + parseInt(this.options.so_luong)), this.data_acc_selected[i].cookie);
                        }
                    }
                    
                },
                share_clone_to_bm:function(i, index, new_index, cookie){
                    ...
                    var url="./api_tool/share_clone_to_bm";
